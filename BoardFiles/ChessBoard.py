...
class Board:
    ...
    def active_move(self, square, time, invert):
        self.magnet.activate()
        self.move_to_square(square, time, compensate=True, invert=invert)
        self.move_to_square(square, .25, invert=invert)
        sleep(.5)
    ...
    def move_piece(self, source, destination, time, invert):
        self.move_to_square(source, time, invert=invert)
        self.active_move(destination, time, invert)

    def move_to_square(self, square, time, compensate=False, invert=False):
        """
